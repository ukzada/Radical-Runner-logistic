...
export async function POST(request: Request) {
  try {
    ...
    const drivers = await Promise.all([
      db.driver.create({ data: { firstName: 'Marcus', lastName: 'Thompson', phone: '(555) 111-0001', email: 'marcus.t@email.com', driverId: 'DRV-001', cdlNumber: 'CDL-T1234567', cdlState: 'GA', cdlExpiration: new Date('2026-08-15'), status: 'ACTIVE', mcId: mcs[0].id } }),
      db.driver.create({ data: { firstName: 'Elena', lastName: 'Rodriguez', phone: '(555) 111-0002', email: 'elena.r@email.com', driverId: 'DRV-002', cdlNumber: 'CDL-R2345678', cdlState: 'TX', cdlExpiration: new Date('2026-03-20'), status: 'ACTIVE', mcId: mcs[1].id } }),
      db.driver.create({ data: { firstName: 'James', lastName: 'Patterson', phone: '(555) 111-0003', email: 'james.p@email.com', driverId: 'DRV-003', cdlNumber: 'CDL-P3456789', cdlState: 'TX', cdlExpiration: new Date('2027-01-10'), status: 'ACTIVE', mcId: mcs[3].id } }),
      db.driver.create({ data: { firstName: 'David', lastName: 'Kim', phone: '(555) 111-0004', email: 'david.k@email.com', driverId: 'DRV-004', cdlNumber: 'CDL-K4567890', cdlState: 'IL', cdlExpiration: new Date('2025-12-05'), status: 'ACTIVE', mcId: mcs[4].id } }),
      db.driver.create({ data: { firstName: 'Carlos', lastName: 'Mendez', phone: '(555) 111-0005', email: 'carlos.m@email.com', driverId: 'DRV-005', cdlNumber: 'CDL-M5678901', cdlState: 'IL', cdlExpiration: new Date('2026-06-30'), status: 'ON_LEAVE', mcId: mcs[5].id } }),
      db.driver.create({ data: { firstName: 'Robert', lastName: 'Williams', phone: '(555) 111-0006', email: 'robert.w@email.com', driverId: 'DRV-006', cdlNumber: 'CDL-W6789012', cdlState: 'FL', cdlExpiration: new Date('2026-09-22'), status: 'ACTIVE', mcId: mcs[5].id } }),
      db.driver.create({ data: { firstName: 'Angela', lastName: 'Brooks', phone: '(555) 111-0007', email: 'angela.b@email.com', driverId: 'DRV-007', cdlNumber: 'CDL-B7890123', cdlState: 'GA', cdlExpiration: new Date('2027-03-15'), status: 'ACTIVE', mcId: mcs[6].id } }),
      db.driver.create({ data: { firstName: 'Tyler', lastName: 'Jackson', phone: '(555) 111-0008', email: 'tyler.j@email.com', driverId: 'DRV-008', cdlNumber: 'CDL-J8901234', cdlState: 'AL', cdlExpiration: new Date('2026-11-30'), status: 'ACTIVE', mcId: mcs[1].id } }),
    ]);
